...
namespace MiPrimerProyecto
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            double[,] tasasdemonedas = {
    { 1.00, 0.91, 18.64, 24.68, 0.91, 8.72, 6.88, 36.67, 937.21, 3999.64, 23.91 }, // Tasa de USD 
    { 1.10, 1.00, 20.49, 27.13, 1.10, 9.59, 7.56, 40.32, 1023.63, 4390.76, 26.21 }, // Tasa de EUR 
    { 0.053, 0.049, 1.00, 1.32, 0.053, 0.47, 0.37, 1.95, 55.08, 211.51, 1.28 }, // Tasa de MXN 
    { 0.040, 0.037, 0.76, 1.00, 0.040, 0.35, 0.28, 1.49, 42.63, 159.21, 0.97 }, // Tasa de HNL 
    { 0.069, 0.063, 1.51, 2.00, 0.069, 0.60, 0.48, 2.55, 70.69, 261.45, 1.61 }, // Tasa de SVC 
    { 0.15, 0.14, 2.73, 3.70, 0.15, 1.29, 1.01, 5.46, 151.48, 569.71, 3.39 }, // Tasa de BOB 
    { 0.027, 0.025, 0.54, 0.71, 0.027, 0.24, 0.19, 1.00, 27.54, 101.52, 0.61 }, // Tasa de NIO 
    { 0.0011, 0.0010, 0.022, 0.030, 0.0011, 0.0096, 0.0076, 0.041, 1.00, 0.12, 0.025 }, // Tasa de ARS 
    { 0.00025, 0.00023, 0.00050, 0.00067, 0.00025, 0.0025, 0.002, 0.010, 0.080, 1.00, 0.006 }, // Tasa de COP 
    { 0.042, 0.038, 0.083, 0.11, 0.042, 0.37, 0.29, 1.58, 65.88, 266.16, 1.00 } // Tasa de CUP 
};
            ...
            Conversor(tasasdemonedas, monedas, "monedas");
